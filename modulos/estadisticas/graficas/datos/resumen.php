...
$x_axis_labels->set_labels(cuantosDe(ENTIDAD,$tabla,false));
...
$xl = new x_legend('Entidades');
$xl->set_style('{font-size: 20px; color: #770077}');
$yl = new y_legend('Catálogos');
$yl->set_style('{font-size: 20px; color: #770077}');
